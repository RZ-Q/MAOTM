...
class RBOMLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        for t in range(batch.max_seq_length):
            agent_outs, role_outs = self.mac.forward(batch, t=t, roles=roles_all[:,t,:,:].reshape(-1))
        ...
        for t in range(batch.max_seq_length):
            target_agent_outs, target_role_outs = self.target_mac.forward(batch, t=t, roles=roles_all[:,t,:,:].reshape(-1))
